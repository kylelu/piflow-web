...
DiagramFormatPanel.prototype.init = function()
{
	...
	{
		/*
		//Appinfo information is annotated here;
...
function updateFlowAttributes(id, name, e) {
    ...
    $.ajax({
        ...
        data: {
            "id": $("#updateFlowId").val(),
            "driverMemory": driverMemoryObj.val(),
            "executorCores": executorCoresObj.val(),
            "executorMemory": executorMemoryObj.val(),
            "executorNumber": executorNumberObj.val(),
        ...
        success: function (data) {
            ...
            if (200 === dataMap.code) {
                ...
                driverMemoryObj.val(flowVo.driverMemory);
                executorCoresObj.val(flowVo.executorCores);
                executorMemoryObj.val(flowVo.executorMemory);
